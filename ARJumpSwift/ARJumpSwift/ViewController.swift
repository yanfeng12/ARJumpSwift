...
class ViewController: UIViewController, ARSCNViewDelegate, ARSessionDelegate {
    ...
    private var currentAnchor: ARAnchor?//锚点
    ...
    var nextDirection: NextDirection = .left
        ...
        if maskTouch {
            ...
            bottleNode.runAction(SCNAction.group(actions), completionHandler: { [weak self] in
                ...
                if (self?.bottleNode.isNotContainedXZ(in: boxNode))! {
                    ScoreHelper.shared.setHighestScore(score: Int((self?.score)!))
